...
slab = Asym_slab(c0=0.6, R1=5/3, R2=2.5, K=None, M_A=0.6)
...
line1 = sol.line_trace_sp(slab.disp_rel, 1, 0.646, 0.01, 0.47, 4, args=(slab.K, slab.M_A))
line2 = sol.line_trace_sp(slab.disp_rel, 1, 0.496, 0.01, 0, 4, args=(slab.K, slab.M_A))
line3 = sol.line_trace_sp(slab.disp_rel, 1, -0.293, 0.01, 0, 4, args=(slab.K, slab.M_A))
line4 = sol.line_trace_sp(slab.disp_rel, 1, -0.613, 0.01, 0.44, 4, args=(slab.K, slab.M_A))
line5 = sol.line_trace_sp(slab.disp_rel, 3, -0.678, 0.01, 2.77, 4, args=(slab.K, slab.M_A))
line6 = sol.line_trace_sp(slab.disp_rel, 2.16, 0.08, 0.01, 0.27, 4, args=(slab.K, slab.M_A))
...
plt.savefig('images_traced/dense4.png', bbox_inches='tight')