...
slab = Asym_slab(c0=1.3, R1=5/9, R2=5/9, K=None, M_A=0.4)
...
line1 = sol.line_trace_sp(slab.disp_rel, 1, 1.975, 0.01, 0, 4, args=(slab.K, slab.M_A))
line2 = sol.line_trace_sp(slab.disp_rel, 1, 1.228, 0.01, 0.1, 4, args=(slab.K, slab.M_A))
line3 = sol.line_trace_sp(slab.disp_rel, 1, 1.028, 0.01, 0, 4, args=(slab.K, slab.M_A))
line4 = sol.line_trace_sp(slab.disp_rel, 1, 0.931, 0.01, 0, 4, args=(slab.K, slab.M_A))
line5 = sol.line_trace_sp(slab.disp_rel, 3, 2.092, 0.01, 2.44, 4, args=(slab.K, slab.M_A))
line6 = sol.line_trace_sp(slab.disp_rel, 0.32, -0.386, 0.01, 0, 4, args=(slab.K, slab.M_A))
line7 = sol.line_trace_sp(slab.disp_rel, 0.32, -0.389, 0.01, 0, 4, args=(slab.K, slab.M_A))
line8 = sol.line_trace_sp(slab.disp_rel, 1, -0.524, 0.01, 0.05, 4, args=(slab.K, slab.M_A))
line9 = sol.line_trace_sp(slab.disp_rel, 1, -1.685, 0.01, 0, 4, args=(slab.K, slab.M_A))
line10 = sol.line_trace_sp(slab.disp_rel, 2.4, 1.238, 0.01, 0.2, 4, args=(slab.K, slab.M_A))
line11 = sol.line_trace_sp(slab.disp_rel, 2, -0.453, 0.01, 0.2, 4, args=(slab.K, slab.M_A))
line12 = sol.line_trace_sp(slab.disp_rel, 2, -1.923, 0.01, 1.3, 4, args=(slab.K, slab.M_A))
line13 = sol.line_trace_sp(slab.disp_rel, 3, -2.034, 0.01, 2.5, 4, args=(slab.K, slab.M_A))

ax.plot(line1[:,0], line1[:,1], color = 'b', linewidth = 2, linestyle='-', label='Sausage')
ax.plot(line4[:,0], line4[:,1], color = 'g', linewidth = 2, linestyle='-', label='Kink')
...
ax.plot(line11[:,0], line11[:,1], color = 'g', linewidth = 2, linestyle='-')
ax.plot(line12[:,0], line12[:,1], color = 'g', linewidth = 2, linestyle='-')
ax.plot(line13[:,0], line13[:,1], color = 'b', linewidth = 2, linestyle='-')
...
plt.savefig('images_traced/evacuated1.png', bbox_inches='tight')