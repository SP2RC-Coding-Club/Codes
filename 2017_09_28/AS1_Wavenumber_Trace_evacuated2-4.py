...
slab = Asym_slab(c0=1.3, R1=5/9, R2=1, K=None, M_A=1.0)
...
line1 = sol.line_trace_sp(slab.disp_rel, 1, 1.23, 0.01, 0.12, 4, args=(slab.K, slab.M_A))
line2 = sol.line_trace_sp(slab.disp_rel, 1, 0.863, 0.002, 0, 4, args=(slab.K, slab.M_A))
line3 = sol.line_trace_sp(slab.disp_rel, 3.2, 0.085, 0.01, 0.1, 4, args=(slab.K, slab.M_A))
line4 = sol.line_trace_sp(slab.disp_rel, 2.32, 0.17, 0.01, 0.1, 4, args=(slab.K, slab.M_A))
line5 = sol.line_trace_sp(slab.disp_rel, 1, -1.292, 0.01, 0.4, 4, args=(slab.K, slab.M_A))
line6 = sol.line_trace_sp(slab.disp_rel, 2, -1.472, 0.01, 1.6, 4, args=(slab.K, slab.M_A))
line7 = sol.line_trace_sp(slab.disp_rel, 3, -1.553, 0.01, 2.8, 4, args=(slab.K, slab.M_A))
...
plt.savefig('images_traced/evacuated4.png', bbox_inches='tight')