...
line1 = sol.line_trace_sp(slab.disp_rel, 0.48, 0.748, 0.01, 0.01, 4, args=(slab.K, slab.M_A))
line2 = sol.line_trace_sp(slab.disp_rel, 0.48, 0.585, 0.01, 0, 4, args=(slab.K, slab.M_A))
line3 = sol.line_trace_sp(slab.disp_rel, 1.84, 1.5, 0.01, 1, 4, args=(slab.K, slab.M_A))
line4 = sol.line_trace_sp(slab.disp_rel, 2, 0.904, 0.001, 0.09, 4, args=(slab.K, slab.M_A))
line5 = sol.line_trace_sp(slab.disp_rel, 2, 0.83, 0.001, 0.19, 4, args=(slab.K, slab.M_A))
