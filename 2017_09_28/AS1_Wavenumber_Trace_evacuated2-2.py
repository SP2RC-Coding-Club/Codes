...
line1 = sol.line_trace_sp(slab.disp_rel, 1, 1.875, 0.01, 0.87, 4, args=(slab.K, slab.M_A))
line3 = sol.line_trace_sp(slab.disp_rel, 1, 1.01, 0.01, 0, 4, args=(slab.K, slab.M_A))
line2 = sol.line_trace_sp(slab.disp_rel, 1, 0.887, 0.01, 0, 4, args=(slab.K, slab.M_A))
line4 = sol.line_trace_sp(slab.disp_rel, 2.4, 1.304, 0.01, 0.1, 4, args=(slab.K, slab.M_A))
line5 = sol.line_trace_sp(slab.disp_rel, 2.4, 1.238, 0.01, 0.15, 4, args=(slab.K, slab.M_A))
line6 = sol.line_trace_sp(slab.disp_rel, 0.36, -0.383, 0.01, 0, 4, args=(slab.K, slab.M_A))
line7 = sol.line_trace_sp(slab.disp_rel, 0.36, -0.388, 0.01, 0, 4, args=(slab.K, slab.M_A))
line8 = sol.line_trace_sp(slab.disp_rel, 1, -0.41, 0.01, 0.1, 4, args=(slab.K, slab.M_A))
line9 = sol.line_trace_sp(slab.disp_rel, 1, -0.516, 0.01, 0.1, 4, args=(slab.K, slab.M_A))
line10 = sol.line_trace_sp(slab.disp_rel, 1, -1.61, 0.01, 0.35, 4, args=(slab.K, slab.M_A))
line11 = sol.line_trace_sp(slab.disp_rel, 2, -1.838, 0.01, 1.75, 4, args=(slab.K, slab.M_A))
line12 = sol.line_trace_sp(slab.disp_rel, 3.52, -1.829, 0.01, 3.2, 4, args=(slab.K, slab.M_A))
...
ax.plot(line12[:,0], line12[:,1], color = 'b', linewidth = 2, linestyle='-')
...
ax.fill_between(x_range, np.maximum(-slab.c1, -slab.c2), y_range[0], color='1', hatch='/')
...
ax.fill_between(x_range, np.minimum(slab.c1, slab.c2), y_range[-1], color='1', hatch='/')

plt.legend(loc=4)

plt.savefig('images_traced/evacuated2.png', bbox_inches='tight')