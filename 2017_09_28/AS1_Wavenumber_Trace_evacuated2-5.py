...
slab = Asym_slab(c0=1.3, R1=5/9, R2=5/9, K=None, M_A=1.4)
...
line1 = sol.line_trace_sp(slab.disp_rel, 1, 1.001, 0.001, 0, 4, args=(slab.K, slab.M_A))
line2 = sol.line_trace_sp(slab.disp_rel, 1, 1.35, 0.01, 0, 4, args=(slab.K, slab.M_A))
line3 = sol.line_trace_sp(slab.disp_rel, 1, 0.651, 0.001, 0.69, 4, args=(slab.K, slab.M_A))
line4 = sol.line_trace_sp(slab.disp_rel, 1, 0.64, 0.01, 0, 4, args=(slab.K, slab.M_A))
line5 = sol.line_trace_sp(slab.disp_rel, 1, 0.594, 0.01, 0.05, 4, args=(slab.K, slab.M_A))
line6 = sol.line_trace_sp(slab.disp_rel, 1, 0.459, 0.01, 0.05, 4, args=(slab.K, slab.M_A))
line7 = sol.line_trace_sp(slab.disp_rel, 1, -1.219, 0.01, 0, 4, args=(slab.K, slab.M_A))
line8 = sol.line_trace_sp(slab.disp_rel, 1, -2.1, 0.01, 0.8, 4, args=(slab.K, slab.M_A))
line9 = sol.line_trace_sp(slab.disp_rel, 3, -1.943, 0.01, 2.4, 4, args=(slab.K, slab.M_A))
line10 = sol.line_trace_sp(slab.disp_rel, 3, -1.397, 0.01, 1.6, 4, args=(slab.K, slab.M_A))
line11 = sol.line_trace_sp(slab.disp_rel, 3.52, -2.071, 0.01, 3.2, 4, args=(slab.K, slab.M_A))
...
ax.plot(line1[:,0], -np.imag(line1[:,1]), color = 'r', linewidth = 2, linestyle='-')
...
plt.savefig('images_traced/evacuated5.png', bbox_inches='tight')