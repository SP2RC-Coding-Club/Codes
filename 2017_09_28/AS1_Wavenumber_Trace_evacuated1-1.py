...
slab = Asym_slab(c0=1.3, R1=5/9, R2=5/9, K=None, M_A=0)
...
line1 = sol.line_trace_sp(slab.disp_rel, 0.64, 0.75, 0.01, 0.01, 4, args=(slab.K, slab.M_A))
line2 = sol.line_trace_sp(slab.disp_rel, 0.55, 0.565, 0.001, 0, 4, args=(slab.K, slab.M_A))
line3 = sol.line_trace_sp(slab.disp_rel, 2, 0.914, 0.001, 0.06, 4, args=(slab.K, slab.M_A))
line4 = sol.line_trace_sp(slab.disp_rel, 1.36, 1.71, 0.01, 0, 4, args=(slab.K, slab.M_A))
line5 = sol.line_trace_sp(slab.disp_rel, 3.12, 1.84, 0.01, 1.67, 4, args=(slab.K, slab.M_A))
line6 = sol.line_trace_sp(slab.disp_rel, 3.76, 2.07, 0.01, 3.27, 4, args=(slab.K, slab.M_A))
line7 = sol.line_trace_sp(slab.disp_rel, 2, 0.833, 0.001, 0.01, 4, args=(slab.K, slab.M_A))
