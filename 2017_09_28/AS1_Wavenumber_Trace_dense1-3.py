...
line1 = sol.line_trace_sp(slab.disp_rel, 0.72, 0.5, 0.01, 0.01, 4, args=(slab.K, slab.M_A))
line2 = sol.line_trace_sp(slab.disp_rel, 0.48, 0.4, 0.01, 0, 4, args=(slab.K, slab.M_A))
line3 = sol.line_trace_mp(slab.disp_rel_mp, 0.96, 0.56, 0.01, 0.01, 4, args=(slab.K, slab.M_A))
line4 = sol.line_trace_mp(slab.disp_rel_mp, 2.4, 0.546, 0.01, 0.01, 4, args=(slab.K, slab.M_A))
line5 = sol.line_trace_mp(slab.disp_rel_mp, 3.68, 0.542, 0.01, 0.01, 4, args=(slab.K, slab.M_A))
