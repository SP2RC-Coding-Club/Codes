...
line1 = sol.line_trace_sp(slab.disp_rel, 0.8, 0.72, 0.01, 0, 4, args=(slab.K, slab.M_A))
line2 = sol.line_trace_sp(slab.disp_rel, 0.8, 0.657, 0.01, 0, 4, args=(slab.K, slab.M_A))
line3 = sol.line_trace_sp(slab.disp_rel, 1.36, 1.58, 0.01, 0, 4, args=(slab.K, slab.M_A))
line4 = sol.line_trace_sp(slab.disp_rel, 3.44, 1.68, 0.01, 2.21, 4, args=(slab.K, slab.M_A))
line5 = sol.line_trace_sp(slab.disp_rel, 2, 0.902, 0.001, 0.06, 4, args=(slab.K, slab.M_A))
line6 = sol.line_trace_sp(slab.disp_rel, 2, 0.83, 0.001, 0.19, 4, args=(slab.K, slab.M_A))
